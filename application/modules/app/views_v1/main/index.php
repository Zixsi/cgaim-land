	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="block-sub-title">Добро пожаловать в онлайн-школу CGAim!</div>
				<div class="text">
					<div class="row img-row mb-4">
						<div class="col-12 col-md-6 order-2 order-md-1">
							<span>Нашей главной целью явлется научить студентов работать с 2D-графикой, 3D-моделированием и анимацией, а более опытным развить навыки и найти новую специализацию. Наша команда не довольна тем контентом, который заполонил интернет, поэтому мы разработали подход, основанный на постоянной практике.</span>
						</div>
					...
					<div class="row img-row">
						...
						<div class="col-12 col-md-6">
							<span>Задача курсов - обучить не только какими кнопками пользоваться в программах, а научить правильно и качественно создавать творческий замысел для игр, мультфильмов и кино. Помимо этого,  познакомитесь с единомышленниками  в закрытом Discord чате.</span>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-10 offset-1">
				...
				<div class="block-sub-title white">Блок курсов для начинающих и более опытных , где познакомитесь с принципами и необходимым инструментом для дальнейшего развития в компьютерной графике.</div>
				<div class="card-deck">
					<?if($courses):?>
						<?$i = 0;?>
			...
			<div class="col-12">
				...
				<div class="row items-list">
					...
					<div class="col-12 col-sm-6 col-lg-3 mb-4 mb-lg-0 text-center item">
						...
						<div class="text">Домашнее задание нужно сдать в конце каждой недели. В ближайший понедельник преподаватель делает видеообзор.</div>
					</div>
					<div class="col-12 col-sm-6 col-lg-3 mb-4 mb-lg-0 text-center item">
						...
						<div class="text">В конце недели проходит онлайн-встреча с преподавателем, на которой вы сможете задавать вопросы и получить дополнительную информацию.</div>
					</div>
					<div class="col-12 col-sm-6 col-lg-3 mb-4 mb-lg-0 text-center item">
