		...
		<div class="price-list">
			<div class="item">
				<div class="body">
					...
					<?endif;?>
					<a href="<?=$schoolUrl?>/courses/<?=$item['code']?>/" class="btn btn-pink" onclick="ym(51851432, 'reachGoal', 'Registration'); return true;">Записаться</a>
				</div>
			</div>
			...
			<?$isEnabledVip = ($item['only_standart'] === false && ((float) $item['price']['vip']['full'] > 0));?>
			<div class="item">
				<div class="body">
					<?if($isEnabledVip):?>
...
<?if(empty($item['examples_code']) === false):?>
	<div id="item-video-works-block">
		<div class="content">
			...
			<iframe width="700" height="375" src="https://www.youtube.com/embed/<?=$item['examples_code']?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
	</div>
<?endif;?>
