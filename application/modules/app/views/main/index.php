				...
				<div class="card">
					<div class="card-body" style="background-image: url('<?=TEMPLATE_DIR?>/assets/works/w8.jpg?v=1');">
						<div class="info">
							...
							<a href="<?=TEMPLATE_DIR?>/assets/works/w8.jpg?v=1" class="btn btn-pink btn-sm" target="_blank">Смотреть</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card">
					<div class="card-body" style="background-image: url('<?=TEMPLATE_DIR?>/assets/works/w2.jpg?v=1');">
						<div class="info">
							...
							<a href="<?=TEMPLATE_DIR?>/assets/works/w2.jpg?v=1" class="btn btn-pink btn-sm" target="_blank">Смотреть</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card">
					<div class="card-body" style="background-image: url('<?=TEMPLATE_DIR?>/assets/works/w3.jpg?v=1');">
						<div class="info">
							...
							<a href="<?=TEMPLATE_DIR?>/assets/works/w3.jpg?v=1" class="btn btn-pink btn-sm" target="_blank">Смотреть</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card">
					<div class="card-body" style="background-image: url('<?=TEMPLATE_DIR?>/assets/works/w4.jpg?v=1');">
						<div class="info">
							...
							<div class="description">Arnold renderer<br>Базовый курс</div>
							<a href="<?=TEMPLATE_DIR?>/assets/works/w4.jpg?v=1" class="btn btn-pink btn-sm" target="_blank">Смотреть</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card">
					<div class="card-body" style="background-image: url('<?=TEMPLATE_DIR?>/assets/works/w5.jpg?v=1');">
						<div class="info">
							...
							<div class="description">Arnold renderer<br>Базовый курс</div>
							<a href="<?=TEMPLATE_DIR?>/assets/works/w5.jpg?v=1" class="btn btn-pink btn-sm" target="_blank">Смотреть</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card">
					<div class="card-body" style="background-image: url('<?=TEMPLATE_DIR?>/assets/works/w6.jpg?v=1');">
						<div class="info">
							<div class="title">Александр Петров</div>
							<div class="description">Arnold renderer<br>Базовый курс</div>
							<a href="<?=TEMPLATE_DIR?>/assets/works/w6.jpg?v=1" class="btn btn-pink btn-sm" target="_blank">Смотреть</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card">
					<div class="card-body" style="background-image: url('<?=TEMPLATE_DIR?>/assets/works/w7.jpg?v=1');">
						<div class="info">
							...
							<div class="description">Arnold renderer<br>Базовый курс</div>
							<a href="<?=TEMPLATE_DIR?>/assets/works/w7.jpg?v=1" class="btn btn-pink btn-sm" target="_blank">Смотреть</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card">
					<div class="card-body" style="background-image: url('<?=TEMPLATE_DIR?>/assets/works/w1.jpg?v=1');">
						<div class="info">
							...
							<div class="description">Основы 3D анимации</div>
							<a href="<?=TEMPLATE_DIR?>/assets/works/w1.jpg?v=1" class="btn btn-pink btn-sm" target="_blank">Смотреть</a>
						</div>
					</div>
				</div>
			</div>
