		...
		<div id="header">
			<div class="panel-menu">
				<div class="container">
					...
					<a href="<?=$urlSchool?>" class="btn btn-sm btn-orange float-right btn--auth d-none d-lg-block" onclick="ym(51851432, 'Registration', 60857359); return true;">Вход / Регистрация</a>
					...
					<ul class="list-unstyled main-menu d-none d-lg-block" id="main-menu">
						...
						<li><a href="<?=$urlSchool?>" class="d-block d-lg-none" onclick="ym(51851432, 'Registration', 60857359); return true;">Вход / Регистрация</a></li>
					</ul>
